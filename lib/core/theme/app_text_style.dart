...
class AppTextStyles extends ThemeExtension<AppTextStyles> {
  ...
  static final light = AppTextStyles(
    ...
    titleMiddle: TextStyle(
      fontSize: 13,
      fontWeight: FontWeight.w400,
      color: ThemeColors.light.titleMiddleColor,
    ),
    snackBarTitle: TextStyle(
      fontSize: 20,
  ...
  static final dark = AppTextStyles(
    ...
    titleMiddle: TextStyle(
      fontSize: 22,
      fontWeight: FontWeight.w500,
      color: ThemeColors.dark.titleMiddleColor,
    ),
    snackBarTitle: TextStyle(
      fontSize: 20,
      fontWeight: FontWeight.w700,
      color: ThemeColors.dark.black,
    ),
  );
  ...
  ThemeExtension<AppTextStyles> copyWith({
    ...
    return AppTextStyles(
      ...
      snackBarTitle: snackBarTitle ?? this.snackBarTitle,
    );
  }
  ...
  ThemeExtension<AppTextStyles> lerp(
    ...
    return AppTextStyles(
      ...
      titleMiddle: TextStyle.lerp(titleMiddle, other.titleMiddle, t)!,
      snackBarTitle: TextStyle.lerp(snackBarTitle, other.snackBarTitle, t)!,
    );
  }
}
