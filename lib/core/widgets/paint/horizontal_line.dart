...
class HorizontalLine extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    paint0Fill.color = const Color(0xffDDE1E4).withOpacity(1.0);
    canvas.drawPath(path_0, paint0Fill);

    Paint paint1Stroke = Paint()
      ..style = PaintingStyle.stroke
      ..strokeWidth = size.width * 0.01875000;
    paint1Stroke.color = const Color(0xffDDE1E4).withOpacity(1.0);
    canvas.drawLine(
        Offset(size.width * 0.1812500, size.height * 0.4464286),
        Offset(size.width * 0.8187500, size.height * 0.4464286),
        paint1Stroke);
    ...
    paint2Fill.color = const Color(0xffDDE1E4).withOpacity(1.0);
    canvas.drawPath(path_2, paint2Fill);

    Paint paint3Fill = Paint()..style = PaintingStyle.fill;
    paint3Fill.color = const Color(0xffA0A9B6).withOpacity(1.0);
